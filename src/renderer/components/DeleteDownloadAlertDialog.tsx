...
interface DeleteDownloadAlertDialogProps {
  open: boolean;
...
export function DeleteDownloadAlertDialog({
  open,
  onOpenChange,
  onConfirm,
  episodeTitle,
}: DeleteDownloadAlertDialogProps) {
  return (
            ...
            <div className="flex items-start gap-3 mb-4">
              ...
              <div className="flex-1 min-w-0 overflow-hidden">
                ...
                <Dialog.Description className="text-[14px] text-[#a1a1aa] leading-relaxed">
                  {episodeTitle && (
                    <span className="block mb-2 font-medium text-[#f4f4f5] truncate max-w-full">
                      {episodeTitle}
                    </span>
                  )}
                  This will remove the downloaded audio file from your computer.
                  The AI summary will be preserved and available in Knowledge.
                </Dialog.Description>
              </div>
            </div>
